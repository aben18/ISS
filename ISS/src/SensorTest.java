...
public class SensorTest {
    ...
    final SolarSensor solarSensor = new SolarSensor();
    int humidityData;
    int tempData;
    int windSpeedData;
    ...
    /**
     * Test getData() for solar sensor
     */
    @Test
    public void testSolarGetData() {
        solarSensor.setWatts(-60);
        solarSensor.setWatts(1302);
        solarSensor.setWatts(523);
        solarData = solarSensor.getData();
        //System.out.println(data);
    ...
    public void testSensorType() {
        ...
        assertTrue(solarSensor.sensorType().equals("SolarSensor"));
    }
    /**
    ...
    public void testCall() throws Exception {
        ...
        // test case for solar sensor call()
        s = solarSensor.call();
        sensorInfo = s.substring(0, 33);
        data = Integer.parseInt(s.substring(33));
        assertTrue(sensorInfo.equals("Solar Radiation(Watts/sq meter): "));
        assertTrue(data > 0 && data < 1800);
    }
    /**
     * Test the output
     */
    ...
    public void testRun() {
        ...
        int humidityData = Integer.parseInt(list.get(4).substring(0, list.get(4).length() - 1)
                .substring(10));
        int solarData = Integer.parseInt(list.get(5).substring(33));
        ...
        assertTrue(list.get(5).substring(0, 33).equals("Solar Radiation(Watts/sq meter): "));
        assertTrue(solarData > 0 && solarData < 1800);
    }
